...
extension StockAdjustmentQuerySortBy
  ...
  QueryBuilder<StockAdjustment, StockAdjustment, QAfterSortBy> sortByAmount() {
    return QueryBuilder.apply(this, (query) {
...
extension StockAdjustmentQuerySortThenBy
  ...
  QueryBuilder<StockAdjustment, StockAdjustment, QAfterSortBy> thenByAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amount', Sort.asc);
    });
  }
...
extension StockAdjustmentQueryWhereDistinct
  ...
  QueryBuilder<StockAdjustment, StockAdjustment, QDistinct> distinctByAmount() {
    return QueryBuilder.apply(this, (query) {
...
extension StockAdjustmentQueryProperty
  ...
  QueryBuilder<StockAdjustment, double, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
