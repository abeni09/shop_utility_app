...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'recurrence': PropertySchema(
      ...
      name: r'recurrence',
      type: IsarType.byte,
      enumMap: _ExpenserecurrenceEnumValueMap,
    ),
  },
...
Expense _expenseDeserialize(
  ...
  object.recurrence =
      _ExpenserecurrenceValueEnumMap[reader.readByteOrNull(offsets[4])] ??
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_ExpenserecurrenceValueEnumMap[reader.readByteOrNull(offset)] ??
              ExpenseRecurrence.none)
          as P;
    default:
...
const _ExpenserecurrenceEnumValueMap = {
  'none': 0,
  'daily': 1,
  'weekly': 2,
  'monthly': 3,
...
const _ExpenserecurrenceValueEnumMap = {
  0: ExpenseRecurrence.none,
  1: ExpenseRecurrence.daily,
  2: ExpenseRecurrence.weekly,
  3: ExpenseRecurrence.monthly,
  4: ExpenseRecurrence.yearly,
};
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedEqualTo(
    DateTime? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> lastUpdatedBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> recurrenceBetween(
    ExpenseRecurrence lower,
    ExpenseRecurrence upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByLastUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByLastUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, DateTime?, QQueryOperations> lastUpdatedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastUpdated');
    });
  }

  QueryBuilder<Expense, ExpenseRecurrence, QQueryOperations>
  recurrenceProperty() {
    return QueryBuilder.apply(this, (query) {
